...
module "apigateway" {
  ...
  allow_origins = ["http://localhost:5173","https://d1pijo2eponbrv.cloudfront.net", "https://snbrepresentaciones.com.ar", "https://d3j844km3iuqvv.cloudfront.net"]
  ...
  lambda_integrations = {
    ...
    admin = {
      ...
      routes = [
        ...
        { method = "DELETE", path = "/admin/companies/{id}", protected = true },
